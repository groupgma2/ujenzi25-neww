...
export const RegisterPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4 py-10 sm:py-12">
      <div className="w-full max-w-xl">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-text">{t('auth.register')}</h1>
          <p className="mt-2 text-text-secondary">{t('auth.createAccount') || 'Create your account to get started'}</p>
        </div>
